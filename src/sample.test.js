...
describe("Bentley.com - ", () => {
  test("Check subheader on page", async () => {
    ...
    await driverTestcase.get("https://www.bentley.com/software/cad-modeling-and-visualization/");
  ...
  test("Check Accessibility widget", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/company/about-us/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
  ...
  test("Check youtube video - projectwise", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/software/projectwise/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
    ...
    const iframeelement = await driverTestcase.findElement(By.css('#section-tzoid-0-558576e6 > div > div.computer'));
    await new Promise((resolve) => setTimeout(resolve, 10000));
    iframeelement.click();
    await new Promise((resolve) => setTimeout(resolve, 10000));
  ...
  test("Check Iframe", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/events/overview/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
  ...
  test("Search Newsroom", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/newsroom");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
    ...
    await driverTestcase.executeScript('window.scrollTo(0, 5000);');
    await new Promise((resolve) => setTimeout(resolve, 5000));
    let elements = await driverTestcase.findElements(By.css('#post-47709 > div > div > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-14f6c38.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default > div > div > div > div.elementor-element.elementor-element-901b0b9.elementor-widget.elementor-widget-wpgb-facet > div > div > nav > ul'));
    let flag = "false";
  ...
  test("Search Channelpartner listing", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/channel-partners/listing/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
  ...
  test("Search Trainingpartner listing", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/product-training-partners/listing/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
  ...
  test("Search Software Page", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/software/overview/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
    const readyState = await driverTestcase.executeScript('return document.readyState');
    //Click on the page 
    ...
    await new Promise((resolve) => setTimeout(resolve, 5000));
    let elements = await driverTestcase.findElements(By.css('#post-53506 > div > div > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-a746b83.elementor-section-full_width.elementor-section-height-default.elementor-section-height-default > div > div.elementor-column.elementor-col-66.elementor-top-column.elementor-element.elementor-element-2d880fa > div > div.elementor-element.elementor-element-30ff2e6.elementor-widget.elementor-widget-wpgb-grid > div > div > div.wpgb-wrapper > div > div > div.wpgb-viewport > div > article.wpgb-card.wpgb-card'));
  ...
  test("Check Header Navigation", async () => {
    ...
    for (let i = 0; i < items.length; i++) {       
      if (await items[i].getText() !== "") {
        if (await items[i].getText() == "Industries") {
          flag = true;
        }
        await items[i].click();
        await new Promise((resolve) => setTimeout(resolve, 10000));
  ...
  test("Generic Search  ", async () => {
    ...
    await new Promise((resolve) => setTimeout(resolve, 4000));
    // Find all elements matching the selector
    let elements = await driverTestcase.findElements(By.css('#content > div > section.elementor-section.elementor-top-section.elementor-element.elementor-element-d06728c.elementor-section-boxed.elementor-section-height-default.elementor-section-height-default > div > div > div > div > div > div.elementor-posts-container.elementor-posts.elementor-posts--skin-classic.elementor-grid > article.elementor-post.elementor-grid-item.post-14340.software.type-software.status-publish.format-standard.hentry > div > h2 > a > mark'));
  ...
  test("Search Resource database", async () => {
    ...
    const driverTestcase = new Builder().usingServer('http://localhost:4444/wd/hub').withCapabilities(capabilities).build();
    await driverTestcase.get("https://www.bentley.com/resources/");
    await driverTestcase.manage().window().maximize();
    await new Promise((resolve) => setTimeout(resolve, 10000));
